...
import { Fish, Plus, Trash2, Settings, BookOpen, ChevronDown, ChevronRight, Check } from "lucide-react";
...
export default function Rentabilidad() {
  ...
  const [tab,       setTab]       = useState("mareas");
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 18, flexWrap: "wrap", alignItems: "center" }}>
        {[["mareas", Fish, "Registro por Marea"], ["especies", BookOpen, "Especies"], ["config", Settings, "Configuración"]].map(([id, Icon, lbl]) => (
        ...
        {tab === "mareas" && embarcaciones.length > 1 && (
