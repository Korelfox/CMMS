  ...
  return (
    <div>
      <PageHead kicker="Administración · Equipo" title="Gestión de Usuarios"
        ...
        action={<button onClick={cargar} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "9px 14px", borderRadius: 9, border: `1px solid ${C.line}`, background: "#fff", color: C.steel, fontSize: 12.5, fontWeight: 600, cursor: "pointer" }}><RefreshCw size={14} /> Actualizar</button>} />
