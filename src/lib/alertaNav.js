...
export const CAMPO_INLINE_DEST = new Set([
  ...
  "solicitudes", "activos", "inventario", "planpm", "prezarpe", "ots",
]);
  ...
  switch (alerta.cat) {
    ...
    case "ia":
      ...
      if (appMode === "campo") {
        ...
        return {
          destino: "activos",
          params: { ...params, vista: "cola" },
          campoEvent: { tab: "activos", params: { ...params, vista: "cola" } },
        };
      }
      break;
