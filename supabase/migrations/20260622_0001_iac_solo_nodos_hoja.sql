-- Alinea el agente IA-C del Vigilante con la métrica del Copiloto.
--
-- IA-C contaba TODOS los equipos con criticidad='A', incluidos sistemas y
-- subsistemas (nodos de agrupación que no acumulan correctivas propias ni se
-- modelan con Weibull). Eso inflaba la cuenta (179 en la flota demo) y divergía
-- del Copiloto, que ya cuenta solo nodos hoja (construirCalidadDatos →
